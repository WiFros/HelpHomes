        ...
        <div class="col-lg-6">
          <div class="row nog rounded-custom align-items-center">
            <input
              ...
              class="rounded-custom custom-input col-lg-5 ms-1"
            />
            <select
              name="condition"
              v-model="option"
              class="rounded-custom custom-select col-lg-3 mx-2"
            >
            ...
            <input
              type="button"
              class="custom-button rounded-custom btn btn-primary col-lg-2 m-2"
              value="검색"
              id="btnSearch"
              @click="searchQna"
            />
      ...
      <div class="table-responsive p-0 scrollable-content">
        <table class="table align-items-center mb-0">
          <thead>
            <tr>
              <th
                class="text-center text-uppercase text-dark text-cs font-weight-bolder opacity-7"
                style="width: 1%"
              >
                번호
              </th>
          ...
          <tbody>
            ...
            >
              ...
              <td class="number-column">
                <div class="d-flex justify-content-center">
                  <h6 class="mb-0 mx-2 text-cs">{{ qna.title }}</h6>
                </div>
              </td>
              ...
              <td class="align-middle text-center number-column">
                <span class="text-csecondary text-cs font-weight-bold">{{
                  qna.wdate
                }}</span>
              </td>
            </tr>
